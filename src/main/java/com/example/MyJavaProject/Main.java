...
class 사람 {
    ...
    void 배달_음식_주문하다() {
        ...
        a좋아하는_음식점.주문(이름, 선호하는_음식의_매운정도, 선호하는_음식);
...
class 음식점 {
    ...
    void 주문(String 주문자, String 맵기, String 음식){

        System.out.printf("%s에서 %s에게 %s %s(을)를 배달합니다.%n", 상호명, 주문자, 맵기, 음식);
